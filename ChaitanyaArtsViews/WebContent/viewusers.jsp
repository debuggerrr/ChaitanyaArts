...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <tr>
    <th>ID</th>
    <th data-th="User Details"><span>Name</span></th>
    <th>Contact</th>
    <th>Email</th>
	<th>Role</th>
	<th></th>
  ...
  <tr>
    ...
    <td>Mugdha Damle</td>
    <td>7030362595</td>
    <td>mugdha.damle@mservices.in</td>
	<td>Employee</td>
	<td><a href="updateuser.jsp" role="button" class="btn btn-primary">View / Edit</a> &nbsp; &nbsp; <a href="#" role="button" class="btn btn-warning">Delete</a></td>
  ...
  <tr>
    ...
    <td>Rakhi Kadam</td>
    <td>8655713101</td>
    <td>rakhi.kadam@mservices.in</td>
	<td>Employee</td>
	<td><a href="updateuser.jsp" role="button" class="btn btn-primary">View / Edit</a> &nbsp; &nbsp; <a href="#" role="button" class="btn btn-warning">Delete</a></td>
  ...
  <tr>
    ...
    <td>Mahesh Pawar</td>
    <td>9096290975</td>
    <td>mahesh.pawar@mservices.in</td>
	<td>Employee</td>
	<td><a href="updateuser.jsp" role="button" class="btn btn-primary">View / Edit</a> &nbsp; &nbsp; <a href="#" role="button" class="btn btn-warning">Delete</a></td>
  ...
  <tr>
    <td>04</td>
    <td>Prasad Kuvalekar</td>
    <td>9029262947</td>
    <td>pradad.kuvalekar@mservices.in</td>
	<td>Employee</td>
	<td><a href="updateuser.jsp" role="button" class="btn btn-primary">View / Edit</a> &nbsp; &nbsp; <a href="#" role="button" class="btn btn-warning">Delete</a></td>
