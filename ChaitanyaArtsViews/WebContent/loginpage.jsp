 ...
 <body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="navbar navbar-static-top">
	...
	<div class="loginbar">
		...
		<div><input name="password" type="password" class="password_textbox" id="password" placeholder="Password Here"></div>
		...
		<div><button type="button" class="btn btn-warning">LOGIN HERE</button></div>
