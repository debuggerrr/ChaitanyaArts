				...
				<div>
					<div class="crevtbl"> 
						...
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell1"></div> 
							<div class="crevtblCell2"><button type="submit" class="btn btn-primary">Update</button> &nbsp; &nbsp;<button type="submit" class="btn btn-warning">Delete</button> <button type="submit" class="btn btn-primary">Cancel</button></div> 
