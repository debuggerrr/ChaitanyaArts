      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div>
				...
				<div><input name="date" class="formtextfield_expences" type="text" id="date"><span class="calender_icon_expences"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></div>
				
				<div class="invoicetext1">Perticular :</div>
				<div><input name="perticular" class="formtextfield_expences1" type="text" id="perticular"></div>
				
				<div class="invoicetext1">Amount :</div>
				<div><input name="perticular" class="formtextfield_expences1" type="text" id="perticular"></div>
				
				<div><button type="button" class="btn btn-warning" style="margin:15px 0px 0px 0px;">Add Expenses</button></div>
				<div class="clear"></div>
			</div>
