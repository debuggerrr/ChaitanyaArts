				...
				<div>
					<div class="crevtbl"> 
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell2"><input name="name" class="formtextfield" type="text" id="name"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Address</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="address" class="formtextfield" type="text" id="address"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Contact</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="contact" class="formtextfield" type="text" id="contact"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Email</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="email" class="formtextfield" type="text" id="email"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Date of Birth (DD/MM/YYYY)</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="birthdate" class="formtextfield" type="text" id="birthdate"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Username</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="username" class="formtextfield" type="text" id="username"></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Role</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><select name="" class="adduserlistbox1">
				  <option>Admin</option>
				  <option>User</option>
				</select></div> 
						</div>
